...
-(void) reset {
    self.frequency.value = self.frequency.initialValue;
    self.carrierMultiplier.value = self.carrierMultiplier.initialValue;
    self.modulatingMultiplier.value = self.modulatingMultiplier.initialValue;
    self.modulationIndex.value = self.modulationIndex.value;
    self.amplitude.value = self.amplitude.initialValue;
}
